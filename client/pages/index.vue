<template>
    <div>
        <div style="position: fixed;width: 100%; height: 100%;left:0;top:0; z-index: -1; overflow: hidden">
            <img style="width: 100%; height: 100%;" src="../assets/bg.jpg" alt="背景图片">
        </div>
		<p class="title">
		    作业管理系统
		</p>
            ...
            <el-tab-pane label="用户登录">
                ...
                <el-form :model="login_module" :rules="loginRule" label-width="100px" label-position="left">
                    <el-form-item label="学号/工号" prop="user_name">
                        <el-input v-model="login_module.user_name" style="width: 200px" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="密码" prop="user_pwd">
                        <el-input v-model="login_module.user_pwd" style="width: 200px" clearable show-password></el-input>
                    </el-form-item>
            ...
            <el-tab-pane label="用户注册">
                <el-form :model="register_module" :rules="registerRule" label-width="100px" label-position="left">
                    <el-form-item label="姓名" prop="user_name">
                        <el-input v-model="register_module.user_name" style="width: 200px" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="学号/工号" prop="user_id">
                        <el-input v-model="register_module.user_id" style="width: 200px" clearable></el-input>
                    </el-form-item>
                    <el-form-item label="密码" prop="user_pwd">
                        <el-input v-model="register_module.user_pwd" type="password" style="width: 200px" clearable show-password></el-input>
                    </el-form-item>
    ...
    export default {
        ...
        data() {
            let validateRepeatPassword = (rule, value, cb) => {
                console.log(value);
                if (cb !== this.register_module.user_confirm_pwd) {
        ...
        methods: {
            submitForm() {
                if(this.type==='1'){
                    ...
                    data = qs.stringify(data); 		//qs.stringify将对象序列化成URL的形式，以&进行拼接
